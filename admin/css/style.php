...
header .logo_and_close,
header .logo_and_close .logo_admin {
  display: flex;
  gap: var(--gap_header);
}
...
.table-modern th,
.table-modern td {
  padding: 5px ; /* Réduit le padding sur mobile */
  text-align: right;
...
@media (min-width: 768px) {
  ...
  .table-modern td::before {
    display: block; /* Masque les labels sur desktop */
  }
}
